package com.example.jojo.bangguseok.broadcast.broadcaster;
...
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.AudioHandler;
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.CameraSurfaceRenderer;
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.TextureMovieEncoder;
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.VideoEncoderCore;
import com.example.jojo.bangguseok.broadcast.broadcaster.network.IMediaMuxer;
import com.example.jojo.bangguseok.broadcast.broadcaster.network.RTMPStreamer;
import com.example.jojo.bangguseok.broadcast.broadcaster.utils.Resolution;
import com.example.jojo.bangguseok.broadcast.broadcaster.utils.Utils;
...
public class LiveVideoBroadcaster extends Service implements com.example.jojo.bangguseok.broadcast.broadcaster.ILiveVideoBroadcaster, com.example.jojo.bangguseok.broadcast.broadcaster.CameraHandler.ICameraViewer, SurfaceTexture.OnFrameAvailableListener {

    private static final String TAG = LiveVideoBroadcaster.class.getSimpleName();
    private volatile static com.example.jojo.bangguseok.broadcast.broadcaster.CameraProxy sCameraProxy;
    private IMediaMuxer mRtmpStreamer;
    private com.example.jojo.bangguseok.broadcast.broadcaster.AudioRecorderThread audioThread;
    private boolean isRecording = false;
    private GLSurfaceView mGLView;
    private CameraSurfaceRenderer mRenderer;
    private com.example.jojo.bangguseok.broadcast.broadcaster.CameraHandler mCameraHandler;
    ...
    public class LocalBinder extends Binder {
        public com.example.jojo.bangguseok.broadcast.broadcaster.ILiveVideoBroadcaster getService() {
    ...
    public void init(Activity activity, GLSurfaceView glView) {
        try {
            ...
            mCameraHandler = new com.example.jojo.bangguseok.broadcast.broadcaster.CameraHandler(this);
    ...
    public boolean startBroadcasting(String rtmpUrl) {
        ...
        try {
            ...
            if (result) {
                ...
                audioThread = new com.example.jojo.bangguseok.broadcast.broadcaster.AudioRecorderThread(SAMPLE_AUDIO_RATE_IN_HZ, recordStartTime, audioHandler);
                audioThread.start();
                isRecording = true;
        ...
        new AsyncTask<Integer, Void, Camera.Parameters>() {
            ...
            protected Camera.Parameters doInBackground(Integer... params) {
                ...
                try {
                    int tryCount = 0;
                    do {
                        sCameraProxy = new com.example.jojo.bangguseok.broadcast.broadcaster.CameraProxy(params[0]);
    ...
    public void changeCamera() {
        ...
        new AsyncTask<Void, Void, Camera.Parameters>() {
            ...
            protected Camera.Parameters doInBackground(Void... voids) {
                releaseCamera();
                try {
                    sCameraProxy = new com.example.jojo.bangguseok.broadcast.broadcaster.CameraProxy(currentCameraId);
                    Camera.Parameters parameters = sCameraProxy.getParameters();
                    if (parameters != null) {
                        setCameraParameters(parameters);
                        return parameters;
