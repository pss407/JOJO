...
package com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles;
...
public class Drawable2d {
    ...
    private static final FloatBuffer TRIANGLE_BUF =
            com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.GlUtil.createFloatBuffer(TRIANGLE_COORDS);
    private static final FloatBuffer TRIANGLE_TEX_BUF =
            com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.GlUtil.createFloatBuffer(TRIANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer RECTANGLE_BUF =
            com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.GlUtil.createFloatBuffer(RECTANGLE_COORDS);
    private static final FloatBuffer RECTANGLE_TEX_BUF =
            com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.GlUtil.createFloatBuffer(RECTANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer FULL_RECTANGLE_BUF =
            com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.GlUtil.createFloatBuffer(FULL_RECTANGLE_COORDS);
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF =
            com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.GlUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS);
