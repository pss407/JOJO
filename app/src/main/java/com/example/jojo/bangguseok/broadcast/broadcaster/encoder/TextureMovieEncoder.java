...
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.EglCore;
...
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.WindowSurface;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private com.example.jojo.bangguseok.broadcast.broadcaster.encoder.VideoEncoderCore mVideoEncoder;
    ...
    {
        try {
            mVideoEncoder = new com.example.jojo.bangguseok.broadcast.broadcaster.encoder.VideoEncoderCore(width, height, bitRate, frameRate, writerHandle);
