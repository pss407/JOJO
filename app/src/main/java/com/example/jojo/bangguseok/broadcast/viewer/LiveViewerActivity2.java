 ...
 */
public class LiveViewerActivity2 extends AppCompatActivity implements OnClickListener, ExoPlayer.EventListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_video_broadcaster_viewer);
        ...
        delayHandler2.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                String URL = myApp.getSend_url();//"https://orrkzjbnurrk2465864.cdn.ntruss.com/video/235_360p_s_l.m3u8";//myApp.getGet_url()   //진홍//"https://gkbjsozvwply2376889.cdn.ntruss.com/video/253_270p_s_l.m3u8";
