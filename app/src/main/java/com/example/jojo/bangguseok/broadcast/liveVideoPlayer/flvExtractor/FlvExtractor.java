 ...
 */
package com.example.jojo.bangguseok.broadcast.liveVideoPlayer.flvExtractor;
...
public final class FlvExtractor implements Extractor, SeekMap {
  ...
  public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {
    ...
    public Extractor[] createExtractors() {
      return new Extractor[] {new com.example.jojo.bangguseok.broadcast.liveVideoPlayer.flvExtractor.FlvExtractor()};
    }
  ...
  // Tags readers.
  private com.example.jojo.bangguseok.broadcast.liveVideoPlayer.flvExtractor.AudioTagPayloadReader audioReader;
  ...
  private boolean readFlvHeader(ExtractorInput input) throws IOException, InterruptedException {
    ...
    if (/*hasAudio && */audioReader == null) {
      audioReader = new com.example.jojo.bangguseok.broadcast.liveVideoPlayer.flvExtractor.AudioTagPayloadReader(
