package com.example.jojo.bangguseok.broadcast.broadcaster.encoder;
...
import com.example.jojo.bangguseok.broadcast.broadcaster.CameraHandler;
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.FullFrameRect;
import com.example.jojo.bangguseok.broadcast.broadcaster.encoder.gles.Texture2dProgram;
...
public class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private com.example.jojo.bangguseok.broadcast.broadcaster.encoder.TextureMovieEncoder mVideoEncoder;
    ...
    public CameraSurfaceRenderer(CameraHandler cameraHandler,
                                 com.example.jojo.bangguseok.broadcast.broadcaster.encoder.TextureMovieEncoder movieEncoder) {
        ...
        if (mRecordingEnabled) {
            ...
            switch (mRecordingStatus) {
                    ...
                    Log.d(TAG, "START recording bitrate: "  +bitrate);
                {
                    ...
                    // start recording
                   boolean started = mVideoEncoder.startRecording(new com.example.jojo.bangguseok.broadcast.broadcaster.encoder.TextureMovieEncoder.EncoderConfig(
